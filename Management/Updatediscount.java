    ...
    public Updatediscount() {
        ...
        btnUpdate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int i=BookUpdateDao.savediscountid(isbn, amount);
                if(i>0){
                    JOptionPane.showMessageDialog(Updatediscount.this,"Update successfully!");
                    //LibrarianSuccess.main(new String[]{});
                    //frame.dispose();

                }else{
                    JOptionPane.showMessageDialog(Updatediscount.this,"Sorry, unable to update !");
                }
            }
        });
